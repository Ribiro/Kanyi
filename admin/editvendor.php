<!-- Edit vendor-->
<div class="modal fade" id="update_vendor<?php echo $fetch['vendor_id']?>">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit <?php echo $fetch['fname']?> vendor</h5>
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="action.php" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="hidden" name="id" value="<?php echo $fetch['vendor_id']?>">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary btn-flat" name="editvendor"><i class="fa fa-save"></i> Save</button>
                </form>
            </div>
        </div>
    </div>
...
<!-- Delete vendor -->
<div class="modal fade" id="delete_vendor<?php echo $fetch['vendor_id']?>">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Delete vendor <?php echo $fetch['fname']?></h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">Do you want to delete vendor <?php echo $fetch ['fname']?> <?php echo $fetch ['lname']?>?</div>
            <div class="modal-footer">
                <form action="action.php" method="post">
                    <input type="hidden" name="id" value="<?php echo $fetch ['vendor_id']?>">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                    <button class="btn btn-danger" type="submit" name="delvendor">Delete</button>
                </form>
